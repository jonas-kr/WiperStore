    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>WIPER STORE was born out of a passion for innovation and a desire
          ...
          <p>Our mission at WIPER STORE is to empower customers with choice, convenience, and confidence.
